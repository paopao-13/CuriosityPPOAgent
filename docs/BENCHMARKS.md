...
| Atari Montezuma | 84x84x4 灰度堆叠 | Discrete(18) | 极稀疏游戏分数 | 平均游戏分数 (pts) | 120 pts | 3500+ pts |
...
| 指标 | PPO Baseline | 本项目目标 |
|------|-------------|-----------|
| 平均分数 | 120 pts | 3500+ pts |
| 提升 | -- | ~29x |

PPO baseline 在 Montezuma 上仅得约 120 分 (接近随机), 三重好奇心驱动的探索预期能突破多房间探索, 达到 3500 分以上。
